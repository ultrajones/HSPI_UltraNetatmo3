...
#Region "Page Building"
  ...
  Function BuildTabOptions(Optional ByVal Rebuilding As Boolean = False) As String
    ...
    Try
      ...
      Dim selGetFavorites As New clsJQuery.jqDropList("selGetFavorites", Me.PageName, False)
      selGetFavorites.id = "selGetFavorites"
      selGetFavorites.toolTip = "Creates HomeSeer3 devices for all Netatmo Weather Stations added to your favorites list."

      Dim strGetFavorites As String = GetSetting("API", "GetFavorites", "0")
      selGetFavorites.AddItem("No", "0", strGetFavorites = "0")
      selGetFavorites.AddItem("Yes", "1", strGetFavorites = "1")

      stb.AppendLine(" <tr>")
      stb.AppendLine("  <td class='tablecell'>Get&nbsp;Favorites</td>")
      stb.AppendFormat("  <td class='tablecell'>{0}</td>{1}", selGetFavorites.Build, vbCrLf)
      stb.AppendLine(" </tr>")
      ...
      selUpdateFrequency.toolTip = "Specify how often the plug-in should read values from your Netatmo Weather Stations."

      Dim txtUpdateFrequency As String = GetSetting("Options", "WeatherStationUpdate", "5")
    ...
    Try
      ...
      Select Case postData("id")
        ...
        Case "selUpdateFrequency"
          Dim value As String = postData(postData("id"))
          SaveSetting("Options", "WeatherStationUpdate", value)
